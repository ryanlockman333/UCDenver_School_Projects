...
int main() {
	...
	do {
		...
		case 'E':
			...
			break;
		default:
			cout << "\nYou entered an invalid selection." << endl;
...
// All the values I entered in outputted the correct results.
// When not entering in a, b, c, d, or e, the program prints you did not enter
//  in the correct selection and, does nothing besides loop over.
// When changing to (validBeverage) nothing happens, stays the same because its a bool, and its still
//  evaluating it as true or false, just saves code space and makes it less typing.
